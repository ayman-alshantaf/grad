...
<head>
    ...
    @include('dashboardPage.layouts.head')
</head>
...
<body>
 ...
 preloader -->
        ...
        @include('dashboardPage.layouts.main-header')

        @include('dashboardPage.layouts.main-sidebar')
 ...
 Main content -->
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-0">{{trans("main_tran.dashboard")}}</h4>
                    </div>
                    <div class="col-sm-6">
 ...
 footer -->
            ...
            @include('dashboardPage.layouts.footer')
