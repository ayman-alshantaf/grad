                     ...
                     {{$descriptionPost->postMajor->name}}
                        ...
                        <div class="Notes-training">
                            ...
                            <ul>
                                ...
                                <li>مكان التدريب
                                    :<span>{{$descriptionPost->postGovernorate->name}} / {{$descriptionPost->desc_place}}</span>
                                </li>
                            ...
                            @else
                                ...
                                <form method="post" action="{{route('addSpeech')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="speech" placeholder="ادخل خطابك للشركة "
                                                  rows="8" required></textarea>
                                        <p class="notic-file"> يفضل تقديم أفضل خطاب للشركة بشكل مفصل ومقنع لقبولك
                                            بالتدريب من قبل الشركة</p>
                                    </div>
                                    <div class="form-group">
                                        <label>ملف السيرة الذاتية</label>
                                        <input type="file" name="cv" class="form-control " required>
                                        <p class="notic-file">الامتدادات المسموحة: pdf, doc, docx. الحجم الاقصى للملف
                                            50MB </p>
                                    </div>
                    ...
                    <div class="section-left-desc-post">
                        ...
                        <div class="other-training">
                            @foreach($similarPosts as $similarPost)
                                <div class="training">
                                    <a href="{{route('descriptionPost' , $similarPost->id)}}">
                                        <h6>{{$similarPost->title}}</h6></a>
