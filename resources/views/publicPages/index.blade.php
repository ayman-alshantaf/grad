    ...
    <div class="section-start">
        ...
        <div class="row">
            <div class="col-md-6 way-border" style="padding: 45px 80px 0px 100px">
                ...
                <p>
                    قم بالبحث على فرصة التدريب المناسبة حسب تخصصك الجامعي من خلال الذهاب لصفحة <a
                            href="{{route('majorsController')}}">التخصصات</a> أو من خلال الذهاب لصفحة <a
                            href="{{route('getPost')}}">فرص التدريب</a>.
                </p>
            </div>
        ...
        <div class="row">
            ...
            >
                ...
                <p>
                    بعد تسجيل الدخول للموقع...وبعد ايجاد فرصة التدريب المناسبة حسب تخصصك...بامكانك الان التقديم لفرصة
                    التدريب المناسبة لك وانتظار رد الشركة على طلبك على بريدك الالكتروني او احد وسائل التواصل الخاص بك.
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="container-slider-company">
                    <div class="company">
                        ...
                        <div class="text-company">
                            <h5>مهنا تكنو</h5>
                            <p>شركة تطوير البرمجيات وتصميم افضل المواقع المتجاوبة مع جميع الشاشات</p>
                            <h6>شركة: <span>مهنا تكنو</span></h6>
                            <h6>تدريب متاح: <span>25 فرصة</span></h6>
                        </div>
                    </div>
