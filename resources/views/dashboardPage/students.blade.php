                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table table-striped table-bordered p-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$student->category_id}}</td>
{{--                                            <td>--}}
{{--                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#edit{{$student->id}}" >مفعل<i class="fa fa-edit"></i></button>--}}
{{--                                            </td>--}}
                                            <td>
                                                <button type="button" class="btn- btn-danger btn-block btn-sm" data-toggle="modal" data-target="#delete{{$student->id}}" >حذف<i class="fa fa-trash"></i></button>
                                            </td>
{{--                                            <td>--}}
                                            ...
                                            <div class="modal fade" id="delete{{$student->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" action="{{route("dashboard.deleteStudents", $student->id)}}">
                                                                @csrf
                                                                <div class="form-group">
                                                                    <div class="col-md">
                                                                        <h6 >هل انت متأكد من حذف المستوى؟؟</h6>
                                                                        <small class="text-dark">{{$student->name}}</small>
                                                                    </div>
