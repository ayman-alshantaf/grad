...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">جميع فرص التدريب</h4>
        </div>
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table table-striped table-bordered p-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$post->governorate_id}}</td>
{{--                                            <td>--}}
{{--                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#edit{{$student->id}}" >مفعل<i class="fa fa-edit"></i></button>--}}
{{--                                            </td>--}}
                                            <td>
                                                <button type="button" class="btn- btn-danger btn-block btn-sm" data-toggle="modal" data-target="#delete{{$post->id}}" >حذف<i class="fa fa-trash"></i></button>
                                            </td>
{{--                                            <td>--}}
...
{{--                                            </div>--}}
                                            ...
                                            <div class="modal fade" id="delete{{$post->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">حذف الفرصة</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form method="post" action="{{route("dashboard.deletePost", $post->id)}}">
                                                                @csrf
                                                                <div class="form-group">
                                                                    <div class="col-md">
                                                                        <h6 >هل انت متأكد من حذف الفرصة؟؟</h6>
                                                                        <small class="text-dark">{{$post->name}}</small>
                                                                    </div>
